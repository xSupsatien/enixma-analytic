...
const struct argp argp = {
    ...
    "\n/usr/local/packages/enixma_analytic/model/day_model.tflite "
    "/usr/local/packages/enixma_analytic/model/night_model.tflite "
    "300 300 80 1920 1080 50 /usr/local/packages/enixma_analytic/label/labels.txt "
...
int parseOpt(int key, char* arg, struct argp_state* state) {
    ...
    switch (key) {
        ...
        case ARGP_KEY_ARG:
            if (state->arg_num == 0) {
                args->day_modelFile = arg;
            } else if (state->arg_num == 1) {
                args->night_modelFile = arg;
        ...
        case ARGP_KEY_INIT:
            ...
            args->threshold         = 0;
            args->chip              = NULL;
            args->day_modelFile     = NULL;
            args->night_modelFile   = NULL;
